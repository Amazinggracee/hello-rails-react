...
```sh
  git clone https://github.com/Amazinggracee/hello-rails-react.git
```
...
Feel free to check the [issues page](https://github.com/Amazinggracee/Hello-React-Rails/issues. )
